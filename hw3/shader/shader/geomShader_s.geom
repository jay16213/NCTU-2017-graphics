    ...
    switch(level)
    {
        ...
        case 1:
        {
            for(int i = 0; i < gl_in.length(); i++)
            {
                ...
                vec3 pe0, pe1, pe2;
                pe0 = v0.vertexEyeSpace - c.xyz;
                pe1 = v1.vertexEyeSpace - c.xyz;
                pe2 = v2.vertexEyeSpace - c.xyz;
                //----------------------------------------------------
                struct Vert v01, v12, v02;

                //v01
                v01.position = normalize(0.5*p0 + 0.5*p1) * radius + c;
                v01.normal = /*normalize(v0.normal + v1.normal)*/normalize(0.5*p0 + 0.5*p1).xyz;
                ...
                v12.normal = /*normalize(v1.normal + v2.normal)*/normalize(0.5*p1 + 0.5*p2).xyz;
                ...
                v02.normal = /*normalize(v0.normal + v2.normal)*/normalize(0.5*p0 + 0.5*p2).xyz;
        ...
        case 2:
        {
            for(int i = 0; i < gl_in.length(); i++)
            {
                ...
                v010.vertexEyeSpace = 0.75*v0.vertexEyeSpace + 0.25*v1.vertexEyeSpace;
                ...
                v011.vertexEyeSpace = 0.50*v0.vertexEyeSpace + 0.50*v1.vertexEyeSpace;
                ...
                v012.vertexEyeSpace = 0.25*v0.vertexEyeSpace + 0.75*v1.vertexEyeSpace;
                ...
                v120.vertexEyeSpace = 0.75*v1.vertexEyeSpace + 0.25*v2.vertexEyeSpace;
                ...
                v121.vertexEyeSpace = 0.50*v1.vertexEyeSpace + 0.50*v2.vertexEyeSpace;
                ...
                v122.vertexEyeSpace = 0.25*v1.vertexEyeSpace + 0.75*v2.vertexEyeSpace;
                ...
                v020.vertexEyeSpace = 0.75*v0.vertexEyeSpace + 0.25*v2.vertexEyeSpace;
                ...
                v021.vertexEyeSpace = 0.50*v0.vertexEyeSpace + 0.50*v2.vertexEyeSpace;
                ...
                v022.vertexEyeSpace = 0.25*v0.vertexEyeSpace + 0.75*v2.vertexEyeSpace;
